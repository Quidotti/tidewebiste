...
<body>
                            ...
                            <nav class="main-menu main-menu-2 white">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <li>
                                            <a href="widerdebate.php">Workforce</i></a>
                                        </li>
                                        <li>
                                            <a href="widerdebate.php">Roundtable</i></a>
                                        </li>
                                        <li>
                                            <a href="debate-inst.html">Wider debates</i></a>
                                        </li>
                                </ul>
                            </nav>
                        </div>
        ...
        <div class="container">
            <div class="row z-5 align-items-center">
                <div class="col-md-8 text-center text-md-left">
                    <h1 class="f-700 green">Proceedings and Acts of the Roundtable Leadership</h1>
                ...
                <div class="col-md-4 text-center text-md-right">
                    <nav aria-label="breadcrumb" class="banner-breadcump">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">PARL</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="case-details pt-90 pb-100">
        <div class="container">
            ...
            <!-- <div class="row">
                <div class="col-lg-6">
                    <p class="mb-30">One of the keyways we operate is through weekly panel discussions. In those panel discussions,
                        guests/members bare their expert opinion on topical issues presented by the Host. The Roundtable
                        Sittings are considered part of this wider debates, albeit focused mainly on national issues. Thus, in
                        Nigeria where we also aim to thoroughly understudy, individuals with good knowledge of the
                        geopolitical zones are appointed as Deans for each of the six zones. Also, individuals are appointed to
                        lead as Deans for specific sectors like Technology, Agriculture, Education, Health e.t.c. With this
                        expertise, information becomes readily available for administering the Institute globally and directing
                        TIDE locally. As an Institute Wider Debates provides educational services with the help of the Friends
                        Through University initiative.</p>
                </div>
                <div class="col-lg-5 offset-lg-1 mt-md-15">
                    <div class="row">
                        <div class="col-sm-4 col-6 remove-pad">
                            <div class="video-area-case relative shadow-2 mt-55 mb-60 mb-md-35">
                                <img src="img/portfolio/video-img.jpg" alt="" class="video-medium">
                                <div class="blob green transform-center">
                                    <a href="https://www.youtube.com/watch?v=qtQgbdmIO30" class="popup-video"> <i class="fas fa-play icon-small"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-6 remove-pad">
                ...
                <div class="col-lg-3 col-sm-4">
                    <div class="footer-links pt-85 pt-md-50 mb-sm-70" >
                        ...
                        <ul class="links-list">
                            ...
                            <li><a href="about-us.html">About Us</a></li>
                            <li><a href="parl.php">PARL</a></li>
                            <li><a href="roundtable.php">Roundtable</a></li>
                            <li><a href="team.html">Board of Visitors</a></li>
                            <li><a href="widerdebate.php">widerdebate</a></li>
